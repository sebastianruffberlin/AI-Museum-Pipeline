...
ABWEICHUNG ZUM BESTAND (bewusst, ergebnis-neutral):
  Der urspruengliche Workflow erzeugte das BMP ueber einen externen
  ImageMagick-Aufruf ("resize, Maximum Area 500, Format bmp"), weil die
  damalige Laufzeitumgebung kein natives Bildresizing erlaubte. In
