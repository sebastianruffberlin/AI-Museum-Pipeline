...
This deployment target does not bundle the GPU model server. It expects an OpenAI-compatible endpoint architecture (e.g. LiteLLM/llama-swap/llama.cpp), as documented under `infra/gpu/`.
